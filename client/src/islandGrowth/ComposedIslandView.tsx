...
// Phase 3 조합 테스트용 미리보기 컴포넌트 - 아직 MapView에는 안 붙임
// (Phase 4). docs/island_growth_visual.md 참고.
export function ComposedIslandView({ islandId, tier, size = 180 }: ComposedIslandViewProps) {
  const composed = composeIsland(islandId, tier, countrysideTerrains, countrysideAssetsByCategory);
