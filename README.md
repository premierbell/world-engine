...
- [x] V1 — Genesis (Java/Spring Boot, `server/`) — Scrap Flow(추출 → 임베딩 → 추천 → 사용자 확인) 전체 루프 완주. 조회 API, 정정 기록, 최소 UI까지 완료.
- [ ] V2 — Evolution (성장 지표, 시각적 티어, Topic 분화)

각 Phase의 상세 근거는 `docs/research_phase_1_summary.md`, `docs/research_phase_2_summary.md`, `docs/v1_design.md` 참고. PR 단위 작업 기록은 `experiments/v0_validation.md`에 누적.
